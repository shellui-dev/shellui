...
public static class SidebarProviderTemplate
{
    public static ComponentMetadata Metadata => new()
    {
        Name = "sidebar-provider",
        DisplayName = "Sidebar Provider",
        Description = "State provider for Sidebar (manages open/collapsed/mobile state)",
