...
public static class ComponentRegistry
{
    public static readonly Dictionary<string, ComponentMetadata> Components = new()
    {
        ...
        { "typed-select", TypedSelectTemplate.Metadata },
        ...
        { "sidebar-models", SidebarModelsTemplate.Metadata },
        { "sidebar-js", SidebarJsTemplate.Metadata },
        { "sidebar-provider", SidebarProviderTemplate.Metadata },
        { "sidebar-header", SidebarHeaderTemplate.Metadata },
        { "sidebar-content", SidebarContentTemplate.Metadata },
        { "sidebar-footer", SidebarFooterTemplate.Metadata },
        { "sidebar-group", SidebarGroupTemplate.Metadata },
        { "sidebar-group-label", SidebarGroupLabelTemplate.Metadata },
        { "sidebar-group-content", SidebarGroupContentTemplate.Metadata },
        { "sidebar-menu", SidebarMenuTemplate.Metadata },
        { "sidebar-menu-item", SidebarMenuItemTemplate.Metadata },
        { "sidebar-menu-button", SidebarMenuButtonTemplate.Metadata },
        { "sidebar-menu-sub", SidebarMenuSubTemplate.Metadata },
        { "sidebar-menu-sub-item", SidebarMenuSubItemTemplate.Metadata },
        { "sidebar-menu-sub-button", SidebarMenuSubButtonTemplate.Metadata },
        { "sidebar-menu-action", SidebarMenuActionTemplate.Metadata },
        { "sidebar-menu-badge", SidebarMenuBadgeTemplate.Metadata },
        { "sidebar-separator", SidebarSeparatorTemplate.Metadata },
        { "sidebar-trigger", SidebarTriggerTemplate.Metadata },
        { "sidebar-inset", SidebarInsetTemplate.Metadata },
        { "sidebar-rail", SidebarRailTemplate.Metadata },
        { "app-sidebar", AppSidebarTemplate.Metadata },
        { "dashboard-01", DashboardLayout01Template.Metadata },
        { "dashboard-02", DashboardLayout02Template.Metadata },
        ...
        { "accordion-type", AccordionTypeTemplate.Metadata },
        ...
        { "command-palette", CommandPaletteTemplate.Metadata },
        { "data-picker", DataPickerTemplate.Metadata },
        { "multi-select", MultiSelectTemplate.Metadata },
        { "tag-input", TagInputTemplate.Metadata },
        ...
        { "context-menu-models", ContextMenuModelsTemplate.Metadata },
        ...
        { "donut-chart", DonutChartTemplate.Metadata },
        { "radar-chart", RadarChartTemplate.Metadata },
        { "radial-chart", RadialChartTemplate.Metadata },
    ...
    public static string? GetComponentContent(string componentName)
    {
        return componentName.ToLower() switch
        {
            ...
            "typed-select" => TypedSelectTemplate.Content,
            ...
            "sidebar-models" => SidebarModelsTemplate.Content,
            "sidebar-js" => SidebarJsTemplate.Content,
            "sidebar-provider" => SidebarProviderTemplate.Content,
            "sidebar-header" => SidebarHeaderTemplate.Content,
            "sidebar-content" => SidebarContentTemplate.Content,
            "sidebar-footer" => SidebarFooterTemplate.Content,
            "sidebar-group" => SidebarGroupTemplate.Content,
            "sidebar-group-label" => SidebarGroupLabelTemplate.Content,
            "sidebar-group-content" => SidebarGroupContentTemplate.Content,
            "sidebar-menu" => SidebarMenuTemplate.Content,
            "sidebar-menu-item" => SidebarMenuItemTemplate.Content,
            "sidebar-menu-button" => SidebarMenuButtonTemplate.Content,
            "sidebar-menu-sub" => SidebarMenuSubTemplate.Content,
            "sidebar-menu-sub-item" => SidebarMenuSubItemTemplate.Content,
            "sidebar-menu-sub-button" => SidebarMenuSubButtonTemplate.Content,
            "sidebar-menu-action" => SidebarMenuActionTemplate.Content,
            "sidebar-menu-badge" => SidebarMenuBadgeTemplate.Content,
            "sidebar-separator" => SidebarSeparatorTemplate.Content,
            "sidebar-trigger" => SidebarTriggerTemplate.Content,
            "sidebar-inset" => SidebarInsetTemplate.Content,
            "sidebar-rail" => SidebarRailTemplate.Content,
            "app-sidebar" => AppSidebarTemplate.Content,
            "dashboard-01" => DashboardLayout01Template.Content,
            "dashboard-02" => DashboardLayout02Template.Content,
            ...
            "accordion-type" => AccordionTypeTemplate.Content,
            ...
            "command-palette" => CommandPaletteTemplate.Content,
            "data-picker" => DataPickerTemplate.Content,
            "multi-select" => MultiSelectTemplate.Content,
            "tag-input" => TagInputTemplate.Content,
            ...
            "context-menu-models" => ContextMenuModelsTemplate.Content,
            ...
            "donut-chart" => DonutChartTemplate.Content,
            "radar-chart" => RadarChartTemplate.Content,
            "radial-chart" => RadialChartTemplate.Content,
